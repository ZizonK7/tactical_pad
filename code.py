...
def apply_starters_to_team(players, team_name, starters):
	...
	for entry in starters:
		...
		if target_label and team_name == "left":
			# FotMob left/home lineup can be lateral-mirrored relative to this board labels.
			target_label = mirror_position_label(target_label)
		matched_player = None
		if target_label:
